...
{
  pg.name("peaclock").version("0.4.3 (11.09.2020)");
  ...
  pg.info({"Key Bindings", {
    ...
    {"+", "add a duration to the current timer or stopwatch value"},
    {"-", "subtract a duration from the current timer or stopwatch value"},
    {"w", "mode clock"},
    {"e", "mode timer"},
    {"r", "mode stopwatch"},
    {"W", "view date"},
  ...
  pg.info({"Commands", {
    ...
    {"stopwatch <value>", {
      ...
      {"start",
        "start the stopwatch"},
      {"add <duration>",
        "add a duration to the current stopwatch time"},
      {"minus <duration>",
        "subtract a duration from the current stopwatch time"},
      {"00h:00m:00s",
    ...
    {"timer <value>", {
      ...
      {"start",
        "start the timer"},
      {"add <duration>",
        "add a duration to the current timer value"},
      {"minus <duration>",
        "subtract a duration from the current timer value"},
      {"00h:00m:00s",
        "set the initial start time"},
    }},
